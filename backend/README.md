...
A docker-compose file definition is available to setup the whole infrastructure with a single command in a containerized environment.

To start the service input:
```bash
